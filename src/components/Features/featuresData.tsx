...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Structured learning paths designed for beginners and enthusiasts, guiding you through real-world projects and skill-building activities.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "Learn to create websites, apps, and automations using intuitive no-code platforms, empowering you to build without needing a developer background.",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "Your hard work during the internship could lead to exciting career opportunities, including a chance to join us or work with industry leaders.",
  },
  {
    id: 4,
    icon: (
    ...
    paragraph:
      "Hands-on training with real-world projects to ensure skill mastery and readiness for career opportunities.",
  },
  {
    id: 5,
    icon: (
    ...
    paragraph:
      "Performance-based recruitment ensures our interns have a chance to join us or connect with industry leaders, launching your career.",
  },
  {
    id: 6,
    icon: (
    ...
    paragraph:
      "Guidance from industry experts with a focus on practical and market-relevant skills to accelerate your learning and growth.",
  },
];
